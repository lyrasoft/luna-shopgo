...
class Order implements EntityInterface
{
    ...
    #[Column('invoice_data')]
    #[Cast(JsonCast::class)]
    protected array $invoiceData = array();
    #[Column('state')]
    ...
    #[Column('payment_data')]
    #[Cast(JsonCast::class)]
    protected array $paymentData = array();
    #[Column('payment_args')]
    #[Cast(JsonCast::class)]
    protected array $paymentArgs = array();
    #[Column('payment_info')]
    #[Cast(JsonCast::class)]
    protected array $paymentInfo = array();
    #[Column('shipping')]
    ...
    #[Cast(JsonCast::class)]
    protected array $shippingData = array();
    #[Column('shipping_args')]
    #[Cast(JsonCast::class)]
    protected array $shippingArgs = array();
    #[Column('shipping_info')]
    #[Cast(JsonCast::class)]
    protected array $shippingInfo = array();
    #[Column('shipping_history')]
    #[Cast(JsonCast::class)]
    protected array $shippingHistory = array();
    #[Column('note')]
