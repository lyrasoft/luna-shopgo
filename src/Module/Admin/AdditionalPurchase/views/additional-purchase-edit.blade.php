 ...
 * @var  $vm        \Lyraoft\ShopGo\Module\Admin\AdditionalPurchase\AdditionalPurchaseEditView  The view model object.
...
use Lyraoft\ShopGo\Module\Admin\AdditionalPurchase\AdditionalPurchaseEditView;
...
@section('content')
    <form name="admin-form" id="admin-form"
        ...
        action="{{ $nav->to('additional_purchase_edit') }}"
