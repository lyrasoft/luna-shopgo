...
class ProductAttributeListView implements ViewModelInterface
{
    ...
    public function prepare(AppContext $app, View $view): array
    {
        ...
        $categoryGroup = $this->orm->from(Category::class)
            ...
            ->where('map.target_id', $ids)
            ->where('map.type', 'attribute')
            ->groupByJoins()
            ->all(Category::class)
            ->groupBy(
    ...
    {
        return 'product_attribute.ordering ASC';
    }
    ...
    {
        return $ordering === 'product_attribute.ordering ASC';
    }
    ...
    protected function prepareMetadata(AppContext $app, View $view): void
    {
        $view->getHtmlFrame()
            ->setTitle(
                $this->trans('unicorn.title.grid', title: 'ProductAttribute')
            );
    }
}
