...
$uniScript->translate('shopgo.product.attribute.option.*');
$uniScript->translate('shopgo.product.attribute.options.*');
$uniScript->translate('shopgo.product.attribute.text.*');
$uniScript->translate('shopgo.product.attribute.button.*');
    ...
    <form name="admin-form" id="admin-form"
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <product-attribute-edit-app id="product-attribute-edit-app"></product-attribute-edit-app>
            </div>
        </div>
