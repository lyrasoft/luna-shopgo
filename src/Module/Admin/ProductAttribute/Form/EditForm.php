    ...
    public function define(Form $form): void
    {
        ...
        $form->fieldset(
            ...
            function (Form $form) {
                ...
                // $form->add('categories', ModalTreeField::class)
                //     ->label($this->trans('shopgo.product.attribute.field.category'))
                //     ->vertical(true)
                //     ->branchSelectable(false)
                //     ->modalTitle($this->trans('shopgo.product.attribute.field.category'))
                //     ->table(Category::class)
                //     ->source(
                //         $this->nav->to('category_tree')->var('type', 'product')
                //     )
                //     ->multiple(true);

                $form->add('categories', CategoryListField::class)
                    ->label($this->trans('shopgo.product.attribute.field.category'))
