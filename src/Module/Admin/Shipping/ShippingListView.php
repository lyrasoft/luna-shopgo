...
use Lyraoft\ShopGo\Module\Admin\Shipping\Form\GridForm;
...
/**
 * The ShippingListView class.
 */
#[ViewModel(
    layout: [
        'default' => 'shipping-list',
        'modal' => 'shipping-modal',
    ],
    js: 'shipping-list.js'
)]
class ShippingListView implements ViewModelInterface
{
    use TranslatorTrait;
    ...
    {
        return $ordering === 'shipping.ordering ASC';
    }
