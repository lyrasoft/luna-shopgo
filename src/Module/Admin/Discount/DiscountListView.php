...
use App\Module\Admin\Discount\Form\GridForm;
...
/**
 * The DiscountListView class.
 */
#[ViewModel(
    layout: [
        'default' => 'discount-list',
        'modal' => 'discount-modal',
    ],
    js: 'discount-list.js'
)]
class DiscountListView implements ViewModelInterface
{
    use TranslatorTrait;
    ...
    {
        return $ordering === 'discount.ordering ASC';
    }
    ...
    protected function prepareMetadata(AppContext $app, View $view): void
    {
        $view->getHtmlFrame()
            ->setTitle(
                $this->trans('unicorn.title.grid', title: 'Discount')
            );
    }
}
