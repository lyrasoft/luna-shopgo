 ...
 * @var  $vm        \Lyraoft\ShopGo\Module\Admin\Discount\DiscountListView The view model object.
...
use Lyraoft\ShopGo\Module\Admin\Discount\DiscountListView;
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <th style="width: 10%" class="text-nowrap">
                            <div class="d-flex w-100 justify-content-end">
                                <x-sort
                                    asc="discount.ordering ASC"
                                    desc="discount.ordering DESC"
                                >
                    ...
                    @foreach($items as $i => $item)
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <a href="{{ $nav->to('discount_edit')->id($entity->getId()) }}">
                                        {{ $item->title }}
                                    </a>
                                </div>
                            </td>
