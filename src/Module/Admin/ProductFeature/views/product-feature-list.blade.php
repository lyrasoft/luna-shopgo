 ...
 * @var  $vm        \Lyraoft\ShopGo\Module\Admin\ProductFeature\ProductFeatureListView The view model object.
...
use Lyraoft\ShopGo\Module\Admin\ProductFeature\ProductFeatureListView;
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <th style="width: 5%" class="text-nowrap">
                            <x-sort field="product_feature.state">
                        ...
                        <th class="text-nowrap">
                            <x-sort field="product_feature.title">
                                @lang('unicorn.field.title')
                            </x-sort>
                        </th>

                        <th class="text-nowrap" style="width: 3%">
                            <x-sort field="product_feature.type">
                                @lang('shopgo.product.feature.field.type')
                            </x-sort>
                        </th>
                        ...
                        <th style="width: 10%" class="text-nowrap">
                            <div class="d-flex w-100 justify-content-end">
                                <x-sort
                                    asc="product_feature.ordering ASC"
                                    desc="product_feature.ordering DESC"
                                >
                        ...
                        <th style="width: 1%" class="text-nowrap text-end">
                            <x-sort field="product_feature.id">
                    ...
                    @foreach($items as $i => $item)
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <a href="{{ $nav->to('product_feature_edit')->id($entity->getId()) }}">
                                        {{ $item->title }}
                                    </a>
                                </div>
                            </td>
