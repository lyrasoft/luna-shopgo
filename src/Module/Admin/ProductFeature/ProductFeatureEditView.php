...
/**
 * The ProductFeatureEditView class.
 */
#[ViewModel(
    layout: 'product-feature-edit',
    js: 'product-feature-edit.js'
)]
class ProductFeatureEditView implements ViewModelInterface
{
    use TranslatorTrait;
    ...
    public function __construct(
        ...
        #[Autowire] protected ProductFeatureRepository $repository
    ) {
    }
    ...
    protected function prepareMetadata(AppContext $app, View $view): void
    {
        $view->getHtmlFrame()
            ->setTitle(
                $this->trans('unicorn.title.edit', title: 'ProductFeature')
            );
    }
}
