...
use Lyrasoft\ShopGo\Module\Admin\ProductFeature\Form\GridForm;
...
/**
 * The ProductFeatureListView class.
 */
#[ViewModel(
    layout: [
        'default' => 'product-feature-list',
        'modal' => 'product-feature-modal',
    ],
    js: 'product-feature-list.js'
)]
class ProductFeatureListView implements ViewModelInterface
{
    use TranslatorTrait;
    ...
    public function __construct(
        protected ORM $orm,
        #[Autowire]
        protected ProductFeatureRepository $repository,
    ...
    {
        return 'product_feature.ordering ASC';
    }
    ...
    {
        return $ordering === 'product_feature.ordering ASC';
    }
    ...
    protected function prepareMetadata(AppContext $app, View $view): void
    {
        $view->getHtmlFrame()
            ->setTitle(
                $this->trans('unicorn.title.grid', title: 'ProductFeature')
            );
    }
}
