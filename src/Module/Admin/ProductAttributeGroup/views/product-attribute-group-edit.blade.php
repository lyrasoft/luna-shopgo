 ...
 * @var  $vm        ProductAttributeGroupEditView  The view model object.
...
use App\Module\Admin\ProductAttributeGroup\ProductAttributeGroupEditView;
...
/**
 * @var Form      $form
 * @var ProductAttributeGroup $item
 */
?>
...
@section('content')
    <form name="admin-form" id="admin-form"
        ...
        action="{{ $nav->to('product_attribute_group_edit') }}"
