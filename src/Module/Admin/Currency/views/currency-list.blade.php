 ...
 * @var  $vm        \Lyraoft\ShopGo\Module\Admin\Currency\CurrencyListView The view model object.
...
use Lyraoft\ShopGo\Module\Admin\Currency\CurrencyListView;
            ...
            <div class="grid-table table-lg-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        {{-- Created by --}}
                        <th class="text-nowrap">
                            <x-sort field="currency.created_by">
