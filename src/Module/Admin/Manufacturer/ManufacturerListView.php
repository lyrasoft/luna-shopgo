...
use Lyrasoft\ShopGo\Module\Admin\Manufacturer\Form\GridForm;
...
/**
 * The ManufacturerListView class.
 */
#[ViewModel(
    layout: [
        'default' => 'manufacturer-list',
        'modal' => 'manufacturer-modal',
    ],
    js: 'manufacturer-list.js'
)]
class ManufacturerListView implements ViewModelInterface
{
    use TranslatorTrait;
    ...
    {
        return $ordering === 'manufacturer.ordering ASC';
    }
