import { resolveVueComponent as X } from "vite-plugin-vue-component-override";
import { data as $, useFieldFlatpickr as tt } from "@windwalker-io/unicorn-next";
import { defineComponent as et, ref as g, computed as D, watch as M, onMounted as ot, createElementBlock as f, openBlock as m, createElementVNode as e, createTextVNode as i, createCommentVNode as y, toDisplayString as r, createVNode as A, withCtx as F, Fragment as nt, renderList as st, normalizeClass as it, withDirectives as b, vModelCheckbox as lt, vModelSelect as J, Transition as dt, vModelText as I, createApp as ut } from "vue";
import { uniqueItemList as rt } from "@lyrasoft/ts-toolkit/vue";
import { h as V } from "./index.es.js";
import { vTooltip as at, ShopGoPlugin as pt } from "../index.js";
import { VueDraggable as ct } from "vue-draggable-plus";
import { _ as ft } from "./_plugin-vue_export-helper.js";
const U = "Y-m-d H:i:S", mt = /* @__PURE__ */ et({
  ...
  setup(u, { expose: t }) {
    ...
    const k = u;
    function n(o) {
      return rt(o).map((l) => (l.checked = !1, l.unsave = !1, l));
    }
    const a = g(n(k.discounts || [])), d = g(), s = g(-1), v = g(""), p = g(null), Q = g(JSON.stringify({
      ...
      time_24hr: !0,
      monthSelect: !1
    })), H = g($("input.step") || "0.0001"), P = D(() => JSON.stringify(a.value));
    let _ = !1;
        ...
        e("div", kt, [
          ...
          e("div", Ut, [
            A(n.VueDraggable, {
              ...
              default: F(() => [
                (m(!0), f(nt, null, st(n.items, (s, v) => (m(), f("div", {
                  key: s.uid,
                  class: it(["list-group-item c-discount-item", { "text-bg-dark": n.current?.uid === s.uid }]),
                  "data-id": s.id
                }, [
                  e("div", Et, [
                    e("div", qt, [
...
const Ce = /* @__PURE__ */ ft(mt, [["render", Se], ["__file", "ProductDiscountsEditApp.vue"]]), De = X("~shopgo/modules/product-edit/ProductDiscountsEditApp.vue", Ce);
function Te(u) {
  const t = ut(De, u);
  return tt(), t.use(pt), t;
}
export {
  Te as initApp
};
