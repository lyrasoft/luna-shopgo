import { resolveVueComponent as S } from "vite-plugin-vue-component-override";
import { defineComponent as P, ref as v, createElementBlock as r, createCommentVNode as y, openBlock as p, createElementVNode as o, createTextVNode as l, toDisplayString as u, createVNode as V, withCtx as I, TransitionGroup as D, Fragment as M, renderList as O, normalizeStyle as T, withDirectives as f, withModifiers as c, vModelCheckbox as q, vModelRadio as L, vModelText as h, createApp as B } from "vue";
import { uniqueItemList as G, uniqueItem as J } from "@lyrasoft/ts-toolkit/vue";
...
const H = /* @__PURE__ */ P({
  ...
  setup(i, { expose: t }) {
    ...
    ), g = v(n.value), e = v(null), d = v([]), A = v(a.value.find((s) => s.data.is_default)?.uid);
    ...
    function w(s = null) {
      const m = s ? a.value.indexOf(s) + 1 : a.value.length, x = J({
        value: "",
        text: "",
        is_default: !1
      }), C = {
      ...
      a.value.splice(m, 0, C), _(C);
    }
    function U(s) {
      const m = a.value.indexOf(s);
      m !== -1 && a.value.splice(m, 1), e.value === s && (e.value = null);
    }
    function E() {
    ...
    const k = { props: b, $typeSelect: n, items: a, type: g, current: e, selected: d, defaultUid: A, selectItem: _, addNewItem: w, removeItem: U, removeItems: E, toJson: N, get VueDraggable() {
      return z;
    } };
  ...
  key: 0,
  style: { opacity: ".5" }
}, at = { class: "c-option-control__actions d-flex align-items-center gap-1" }, ut = ["value", "id"], rt = ["for"], pt = ["onClick"], vt = ["onClick"], mt = { class: "d-none" }, ft = ["name", "value"], ct = ["name", "value"], bt = ["name", "value"], gt = ["name", "checked", "value"], yt = { class: "col-lg-6 l-feature-option-item" }, _t = { class: "card c-option-edit" }, kt = { class: "card-header" }, xt = { class: "card-body" }, Ct = {
  key: 0,
        ...
        o("div", tt, [
          V(n.VueDraggable, {
            ...
            default: I(() => [
              V(D, { name: "fade" }, {
                default: I(() => [
                  (p(!0), r(M, null, O(n.items, (e) => (p(), r("div", {
                    key: e.uid,
                    class: "list-group-item c-option-item",
                    style: T([[n.current === e ? "background: rgba(var(--bs-primary-rgb), .3)" : "", "animation-duration: .3s;"], { cursor: "pointer" }]),
      ...
      o("div", _t, [
        ...
        o("div", xt, [
          n.current ? (p(), r("div", Ct, [
            ...
            t[30] || (t[30] = l()),
            n.type === "select" ? (p(), r("div", ht, [
              o("label", At, u(i.$lang("shopgo.product.attribute.option.value")), 1),
              t[29] || (t[29] = l()),
              f(o("input", {
...
const St = /* @__PURE__ */ F(H, [["render", Nt], ["__file", "ProductAttributeEditApp.vue"]]), Pt = S("~shopgo/modules/product-attribute/ProductAttributeEditApp.vue", St);
function Gt(i) {
  const t = B(Pt, i);
  return t.use(R), t;
}
