import { resolveVueComponent as A } from "vite-plugin-vue-component-override";
import { defineComponent as F, ref as m, createElementBlock as u, openBlock as p, createElementVNode as o, createTextVNode as l, toDisplayString as a, createVNode as V, withCtx as I, TransitionGroup as O, Fragment as D, renderList as U, normalizeClass as T, createCommentVNode as h, withDirectives as v, withModifiers as b, vModelCheckbox as q, normalizeStyle as z, vModelText as y, createApp as L } from "vue";
import { uniqueItemList as M, uniqueItem as B } from "@lyrasoft/ts-toolkit/vue";
import { useCssImport as G } from "@windwalker-io/unicorn-next";
import { VueDraggable as J } from "vue-draggable-plus";
import "bootstrap";
import { vColorpicker as j, ShopGoPlugin as H } from "../index.js";
...
const Q = /* @__PURE__ */ F({
  ...
  setup(s, { expose: t }) {
    ...
    function P(i) {
      const g = i ? r.value.indexOf(i) + 1 : r.value.length, x = B({
        value: "",
        text: "",
        color: ""
      }), C = {
    ...
    const k = { $typeSelect: c, props: n, type: f, items: r, current: e, selected: d, colorPickerOptions: w, selectItem: _, addNewItem: P, removeItem: E, removeItems: N, toJson: S, get VueDraggable() {
      return J;
    }, get vColorpicker() {
      return j;
    } };
              ...
              V(O, { name: "fade" }, {
                default: I(() => [
                  (p(!0), u(D, null, U(n.items, (e) => (p(), u("div", {
                    key: e.uid,
                    class: T(["list-group-item c-option-item", [{ active: n.current === e }]]),
...
const At = /* @__PURE__ */ K(Q, [["render", St], ["__file", "ProductFeatureEditApp.vue"]]), Ft = A("~shopgo/modules/product-feature/ProductFeatureEditApp.vue", At);
function Bt(s) {
  const t = L(Ft, s);
  return t.use(H), t;
}
